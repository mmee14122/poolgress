/**
 * 一頁式首頁（landing.html）內容 — 2026-09-06。
 *
 * 與 premium-demo.ts 同一套設計，但這裡是「現在做得到」的版本：
 * 站內只有這一頁，導覽是頁內錨點，對外連結只留 App 下載頁與信箱；
 * 線上課程／實戰闖關／教練／購物車／登入等尚未開放的入口一律不出現。
 * 兩份資料刻意分開，之後 landing 要改版不會動到現行首頁。
 */
...
export const hero = {
  ...
  cta: { label: '探索 App', href: '/app' },       /* 2026-09-16 使用者：導到 App 玩法頁 */
  /** 第二顆 Hero CTA（2026-09-06 使用者）：與第一顆同款，指向 02 / THE APP 章節 */
  /** 2026-09-16 使用者：改成「尋找教練 →」，指向 02 教練區的眉標錨點 #coach；箭頭改水平（見 LandingApp） */
  ctaSecondary: { label: '尋找教練', href: '/coaches.html' },   /* 2026-09-16 使用者：導到合作教練列表頁 */
}
...
export const brand = {
  ...
  navCta: { label: '下載 App', href: './app.html' },
}
