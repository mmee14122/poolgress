...
export function FitFor() {
  return (
    <Section id="fit" title="這堂課適合誰？">
      ...
      {course.fit.prereq && (
        <p className="mt-5 flex items-start gap-2.5 rounded-card bg-pulse-100 px-5 py-4 text-sm text-pulse-700">
          <svg viewBox="0 0 20 20" aria-hidden="true" className="mt-0.5 h-4 w-4 shrink-0 fill-pulse-700">
